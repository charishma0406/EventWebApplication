...
namespace WebMVC.services
{
    public class OrderService : IOrderService
    {
        ...
        async public Task<Stripe.Order> GetOrder(string id)
        {
            ...
            var response = JsonConvert.DeserializeObject<Stripe.Order>(dataString);

            return response;
        }

        public async Task<List<Stripe.Order>> GetOrders()
        {
            var token = await GetUserTokenAsync();
            ...
            var response = JsonConvert.DeserializeObject<List<Stripe.Order>>(dataString);

            return response;
        }


        public async Task<int> CreateOrder(Stripe.Order order)
        {
            var token = await GetUserTokenAsync();
        ...
        public Task<int> CreateOrder(Models.OrderModels.Order order)
        {
